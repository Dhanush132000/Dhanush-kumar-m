    ...
    <div className='pb-20 pt-36'>
      ...
      <Spotlight className='-top-28 -left-80
       h-[80vh] w-[50vw]' fill='blue'/>
        ...
        <div className="h-[50rem] w-full dark:bg-black-100 
        bg-white  dark:bg-grid-white/[0.01] bg-grid-black/[0.2]
      ...
      <div className='flex justify-center relative my-20 z-10'>
        ...
        justify-center'>
         ...
         <TextGenerateEffect 
          ...
          words='Transforming my Thoughts into
          Reality'
          />
          ...
          <p className='text-center mb-4 text-sm md:text-lg lg:text-2xl'>
            Hello, I&apos;am Dhanush,<br/>
            Next.js Developer based in India
          </p>

          <div>
            <h2 className='text-center mb-4 text-sm md:text-lg lg:text-2xl'>
           <Typewriter 
           words={[ "HELLO",
            "Namaste"
           ]}
