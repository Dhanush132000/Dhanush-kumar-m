...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText('dhanushpatali0@gmailcom');
      ...
      <div className={`${id === 6 && 'flex justify-center '} h-full `}>
        ...
        {id === 6 && (
          <BackgroundGradientAnimation>
           {/* <div className="absolute z-50 flex items-center justify-center text-center
            font-bold" />*/}
          </BackgroundGradientAnimation>
        )}
        ...
        <div className={cn(
          ...
          text-[#clc2d3] text-sm md:text-xs lg:text-base z-10">
            {description}
          </div>
